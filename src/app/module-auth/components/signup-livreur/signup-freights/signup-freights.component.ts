...
@Component({
  selector: 'app-signup-freights',
  templateUrl: './signup-freights.component.html',
  styleUrls: ['./signup-freights.component.scss']
})
export class SignupFreightsComponent implements OnInit {
  ...
  public onSubmit(){
    ...
    if(!this.signupForm.valid){
      ...
      return ;}
      this.isLoading = true;
    this.authService.registerFreights(this.signupForm.value, this.currentFile).subscribe(
      data => {
